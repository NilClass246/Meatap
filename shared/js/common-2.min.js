  ...
  "undefined" == typeof jQuery
    ...
    : $(function () {
        if (
                  ...
                  setInterval(function () {
                    $(".goog-te-banner-frame").length &&
                      ("none" == $(".skiptranslate").css("display")
                        ? e &&
                          ("block" == $("#menu_sp").css("display")
                            ? $("#menu, #menu_sp").css("top", 0)
                            : $("#menu").css("top", 0))
                        : (e &&
                            ("block" == $("#menu_sp").css("display")
                              ? $("#menu, #menu_sp").css("top", 39)
                              : $("#menu").css("top", 39)),
                          480 > $(window).width()
                            ? $("iframe:first")
                                .contents()
          ...
          if (
            (aidn.util.checkJapanese() && (e = aidn.constant.advUrlJa),
            (e =
              '<a href="' +
              e +
              '" target="_blank"><div class="adv_con"><p class="text">' +
            ...
            $(".adv").html(e), $("body").css("overflow", "auto");
          else {
...
0 < hr.indexOf("a.aidn") && (location.href = hr.split("a.aidn").join("aidn")),
  0 < hr.indexOf("www.aidn") &&
    (location.href = hr.split("www.aidn").join("aidn"));
var aidn = aidn || {};
aidn.constant = {
...
(aidn.init = {
  ...
  (aidn.config = {
    init: function () {
      (this.clWidth = document.documentElement.clientWidth),
        ...
        (0 >= this.clHeight || 0 >= this.clWidth) &&
          ((this.clWidth = this.scWidth), (this.clHeight = this.scHeight)),
        (0 >= this.inHeight || 0 >= this.inWidth) &&
  ...
  (aidn.event = {
    ...
    remove: function (e, t, n, i, o) {
      (aidn.config.touchEnabled
        ...
        : this.removeMouseEvent)(e, t, n, i, o);
    },
  ...
  (aidn.ref = {
    ...
    addInterval: function (e, t) {
      (this.__list[this.__total] = { time: 0, delay: t, func: e }),
        0 == this.__total &&
    ...
    needExpandArea: function (e) {
      ...
      return (
        (n =
          n &&
          0 <= t.indexOf("Version/") &&
          600 > Math.max(window.screen.width, window.screen.height)) &&
          1 == e &&
  ...
  (aidn.window = {
    ...
    addDummyDiv: function () {
      if (aidn.window.useDummyDiv()) {
        ...
        e.css({ width: "100%", height: "100%", position: "fixed", zIndex: -1 }),
...
(_active =
  ...
  (aidn.Audio = function () {
    ...
    (this._audio = d),
      ...
      (this.play = function (i, a, s, c, u) {
        ...
        d.play(),
          0 < c && "undefined" != typeof jQuery
            ? ((r.volume = 0),
              $(r)
                .stop()
                .animate({ volume: u }, 1e3 * c, "easeInSine"))
            : (r.volume = u);
      }),
      (this.pause = function () {
        d.pause();
  ...
  (aidn.WebAudio = function () {
    ...
    (this.load = function (e, i, o) {
      function a() {
        t.decodeAudioData(
          f ? r.buffer : b.response,
          function (e) {
            if (0 <= w) {
              for (
                var o = w, a = Number.MAX_VALUE, r = e.numberOfChannels, f = 0;
                f < r;
                f++
              ) {
                for (
                  var p = (b = e.getChannelData(f)).length, v = 0;
                  v < p && !(o < Math.abs(b[v]));
                  v++
                );
                v < a && (a = v);
              ...
              for (
                p = e.length - a, o = t.createBuffer(r, p, t.sampleRate), f = 0;
                f < r;
                f++
              ) {
      ...
      (this.play = function (f, g, w, b, x, E) {
        if (((d = f), (s = g), (c = w), (u = b), (l = x), (h = E), n)) {
          ...
          if (
            (i.start ? i.start(t.currentTime + E, f) : i.noteOn(f),
            (v = t.currentTime - f),
            (this._source = i),
            (this.nodeGain = a),
            0 < b && "undefined" != typeof jQuery
              ? ((m.volume = 0),
                $(m)
                  .stop()
                  .animate({ volume: x }, 1e3 * b, "easeInSine"))
              : (m.volume = x),
            w)
          )
      ...
      (this.initBiquadFilter = function (e) {
        return (
          void 0 === e && (e = 0), (r = t.createBiquadFilter()), (r.type = e), r
        );
      }),
  ...
  (aidn.AutoAudio = function (e, t, n) {
    ...
    (this.load = function () {
      ...
      (this.play = function () {
        0 == i &&
          arguments[2] &&
          ((r = arguments[2]), (arguments[2] = "___flash_audioPlay")),
